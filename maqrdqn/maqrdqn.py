...
def qrdqn(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
          steps_per_epoch=4000, epochs=50, replay_size=int(1e6), gamma=0.99,
          polyak=0.995, pi_lr=1e-3, q_lr=1e-3, batch_size=100, start_steps=10000,
          update_after=1000, update_every=50, act_noise=0.1, num_test_episodes=10,
          max_ep_len=1000, logger_kwargs=dict(), save_freq=1, kappa=1.0, N=200):
    """
    ...
    ac = actor_critic(env.observation_space, env.action_space, N, **ac_kwargs)
    taus = torch.arange(
    ...
    def compute_loss_q(data):
        ...
        with torch.no_grad():
            ...
            next_sa_quantiles = ac_targ.q(o2, ac_targ.pi(o2)).unsqueeze(dim=-1).transpose(1, 2)
    ...
    def compute_loss_pi(data):
        ...
        if use_gpu:
            o = o.to(torch.device('cuda'))
        q_pi = (ac.q(o, ac.pi(o))).mean(dim=-1)
        return -q_pi.mean()
    ...
    for t in range(total_steps):
        ...
        replay_buffer.store(o, a, r/50.0, o2, d)
...
if __name__ == '__main__':
    ...
    qrdqn(lambda: gym.make(args.env), actor_critic=core.MLPActorCritic,
